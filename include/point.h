...
point_t get_intersection_point(const point_t &alpha, const point_t &beta, const point_t &gamma, const point_t &theta) {
    point_t result;
...
double get_vector_product(const point_t &alpha, const point_t beta, const point_t theta) {
