...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/src/tests.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} gtest/dist/Debug/MinGW-Windows/libgtest.a 


${TESTDIR}/src/tests.o: src/tests.cpp 
	${MKDIR} -p ${TESTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -I. -Igtest-1.7.0 -Igtest-1.7.0/include -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests.o src/tests.cpp
